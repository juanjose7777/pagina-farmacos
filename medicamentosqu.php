...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="contactano.php">Contactanos</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="medicamentosna.php">medicamentos naturales</a>
          <a class="dropdown-item" href="medicamentosqu.php">medicamentos quimicos</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">muy pronto.....</a>
        </div>
      </li>
      <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="buscar" placeholder="buscar de medicamentos" aria-label="buscador de medicamentos">
