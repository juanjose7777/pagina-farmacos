...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">Fármacos.info</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">nolose bro</a>
        </div>
      </li>
      <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="buscar" placeholder="buscar" aria-label="buscador">
      <button class="btn btn-outline-warning my-2 my-sm-0" type="submit">buscador</button>
    </form>
  </div>
</nav>
    ...
    <div class="col-12 col-md-4 col-lg-5"><br>
  ...
  <div class="form-group">
    <input type="password" class="form-control" 
          name="pass"
    id="exampleInputPassword1" placeholder="clave papu">
  </div>
